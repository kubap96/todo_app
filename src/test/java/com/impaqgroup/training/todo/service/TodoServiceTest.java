package com.impaqgroup.training.todo.service;
...
import com.impaqgroup.training.todo.utils.ForbiddenException;
...
public class TodoServiceTest {
    ...
    private static final Todo PLAIN_USER_TODO = new Todo(
            ID, "todo1", "priority1", "about todo1", true, PLAIN_USER.getLogin());

    private static final Todo ADMIN_USER_TODO = new Todo(
            ID, "todo1", "priority1", "about todo1", true, ADMIN_USER.getLogin());
    ...
    private void plainUserIsLoggedIn() {
        ...
        when(currentUserProvider.getCurrentUserName()).thenReturn(LOGGED_USER_PLAIN.getLogin());
    }
    ...
    private Todo withLoggedUserName(Todo todo) {
        return Todo.builder()
                ...
                .username(LOGGED_USER_PLAIN.getLogin())
